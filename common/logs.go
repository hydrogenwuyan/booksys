...
//调试日志
func LogFuncDebugFormat(args ...interface{}) {
	str, err := json.MarshalIndent(args, "", "    ")
	beego.Debug(formatWithFileLine("%v,err:%v", string(str), err))
}
